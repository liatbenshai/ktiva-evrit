...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const contentStyleConfigMap = {
      ...
      legal: {
        promptInstruction: `ניסוח משפטי פורמלי ומדויק. כתוב בלשון משפטית תקינה, עם שימוש במונחים כגון "למען הסר ספק", "האמור לעיל אינו גורע", "בהתאם להוראות סעיף", "כפוף לאמור", "מוסכם ומוצהר", "החייב". העדף משפטים מורכבים המחולקים בפסיקים ובנקודות-פסיק. הימנע מרוח אישית, סלנג או פנייה ישירה. אפשר לשלב סעיפים ממוספרים (1.1, 1.2) והגדרות במידת הצורך. שמור על עקביות בזמנים (בעיקר פועל בעתיד: "יתחייב", "ישיב") ובמגדר.`,
        systemTone: 'סגנון משפטי פורמלי ומחמיר בדומה לחוזים, תקנונים וחוות דעת משפטיות רשמיות.',
        label: 'משפטי',
      },
      academic: {
