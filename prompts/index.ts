...
- **חשוב מאוד: המספור (1), (2) וכו' חייב להיות בשורה נפרדת מעל המספר הראשון!**
...
- סדר: שורה 1 - מספור (1), שורה 2 - המספר הראשון מיושר ימינה, שורה 3 - סימן + והמספר השני מיושר כך שהמספרים מתיישרים, שורה 4 - קו הפרדה (---), שורה 5 - תשובה
